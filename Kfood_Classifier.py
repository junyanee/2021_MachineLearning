...
# npy 파일로 저장
np.save("kFood_kind_image_data_Lenet5.npy", xy)
...
# 전처리한 데이터 로드
x_train, x_test, y_train, y_test = np.load('./kFood_kind_image_data_Lenet5.npy', allow_pickle = True)
...
# 신경망 모델 #
cnn = Sequential()
cnn.add(Conv2D(6, (5, 5), padding = 'same', activation = 'relu', input_shape = (image_width, image_height, 3))) #커널 개수, 사이즈 미입력
