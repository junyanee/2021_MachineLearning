# -*- coding: utf-8 -*-
"""
Created on Thu May  6 16:33:37 2021
...
# Comparing accuracy between MSE and CE moel
res_mse = dmlp_mse.evaluate(x_test, y_test, verbose = 0)
print("Accuracy of MSE model is", res_mse[1] * 100)

res_ce = dmlp_ce.evaluate(x_test, y_test, verbose = 0)
print("Accuracy of CE model is", res_ce[1] * 100)

import matplotlib.pyplot as plt

# Comparing in one graph
